...
local WorldPosition=vector.create(WorldX,WorldY,WorldZ)local
...
local FillOpacity=Options.FillOpacity or 0.2

local MainThickness=Options.MainThickness or 3
